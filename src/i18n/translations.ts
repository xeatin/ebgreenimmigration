...
export const translations = {
  ...
  contact: {
    ...
    sidebarTitle1: { pt: "Pronto para iniciar sua", en: "Ready to start your", es: "¿Listo para iniciar su" },
    sidebarTitleHighlight: { pt: "avaliação?", en: "assessment?", es: "evaluación?" },
    sidebarSubtitle: {
      pt: "Responda algumas perguntas rápidas e receba uma análise preliminar do seu perfil, com orientação clara sobre os caminhos migratórios mais adequados e os próximos passos.",
      en: "Answer a few quick questions and receive a preliminary analysis of your profile, with clear guidance on the most suitable immigration paths and the next steps.",
      es: "Responda algunas preguntas rápidas y reciba un análisis preliminar de su perfil, con orientación clara sobre los caminos migratorios más adecuados y los próximos pasos.",
    },
