          ...
          {s.items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="text-center group p-6 rounded-xl border-2 bg-card border-border hover:border-brand-green/50 hover:shadow-[0_0_0_1px_hsl(var(--brand-green)/0.35)] transition-all cursor-pointer hover:-translate-y-1"
              >
