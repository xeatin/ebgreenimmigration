...
const blogPosts: BlogPost[] = [
  ...
  {id:3, titulo:"EB-1A: Quando Voce se Qualifica como Talento Extraordinario", categoria:"EB-1A", data:"03 mar 2026", leitura:"9 min", imagem:"https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80&fit=crop", excerpt:"Explore os dez sinais que mostram que você está pronto para dar o próximo passo na carreira americana."},
  ...
  {id:9, titulo:"Visto F-1: Como Estudar nos EUA e Viver a Experiência Universitária", categoria:"F-1", data:"09 mar 2026", leitura:"8 min", imagem:"https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=600&q=80&fit=crop", excerpt:"Descubra como é estudar em uma universidade americana e mergulhar em uma experiência acadêmica transformadora."},
  ...
  {id:15, titulo:"OPT e STEM Extension: Ganhe Experiência Profissional nos EUA Após a Graduação", categoria:"F-1", data:"15 mar 2026", leitura:"8 min", imagem:"https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&q=80&fit=crop", excerpt:"Veja como recém-formados ganham experiência prática em empresas americanas e dão impulso real à carreira."},
