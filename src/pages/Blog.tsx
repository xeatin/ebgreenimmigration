...
const blogPosts: BlogPost[] = [
  ...
  {id:5, titulo:"EB-5: Green Card por Investimento para Brasileiros em 2026", categoria:"EB-5", data:"05 mar 2026", leitura:"11 min", imagem:"https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&q=80&fit=crop", excerpt:"Com aportes a partir de USD 800 mil no EB-5, analise riscos, vantagens, centros regionais aprovados e o cenario atual para investidores brasileiros."},
  {id:6, titulo:"EB-3: Green Card para Trabalhadores Qualificados e Nao Qualificados", categoria:"EB-3", data:"06 mar 2026", leitura:"9 min", imagem:"https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&q=80&fit=crop", excerpt:"O visto EB-3 abre portas para trabalhadores com ou sem diploma universitario. Entenda como conseguir um patrocinador e obter o Green Card."},
  {id:7, titulo:"Visto E-2: Como Brasileiros Podem Investir e Morar nos EUA", categoria:"E-2", data:"07 mar 2026", leitura:"10 min", imagem:"https://images.unsplash.com/photo-1444653614773-995cb1ef9efa?w=600&q=80&fit=crop", excerpt:"O visto E-2 permite que investidores brasileiros vivam e trabalhem nos EUA com aportes menores que o EB-5. Descubra os requisitos e setores ideais."},
  {id:8, titulo:"Visto EB-3: Caminho para Profissionais Qualificados e Trabalhadores", categoria:"EB-3", data:"08 mar 2026", leitura:"9 min", imagem:"https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=600&q=80&fit=crop", excerpt:"O EB-3 e uma rota acessivel ao Green Card para profissionais qualificados, trabalhadores especializados e nao especializados com oferta de emprego nos EUA."},
  {id:9, titulo:"Visto F-1: Estudar nos EUA e Construir seu Caminho para o Green Card", categoria:"F-1", data:"09 mar 2026", leitura:"8 min", imagem:"https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=600&q=80&fit=crop", excerpt:"O visto F-1 e a porta de entrada para universidades americanas. Saiba como transitar do F-1 para vistos de trabalho e residencia permanente."},
  {id:10, titulo:"Visto R-1: Trabalhadores Religiosos e o Caminho para o Green Card", categoria:"R-1", data:"10 mar 2026", leitura:"7 min", imagem:"https://images.unsplash.com/photo-1438032005730-c779502df39b?w=600&q=80&fit=crop", excerpt:"O visto R-1 e destinado a lideres religiosos e trabalhadores de organizacoes religiosas nos EUA. Entenda os requisitos e como solicitar."},
  {id:11, titulo:"Visto E-2: Como Empreender nos EUA com Investimento Substancial", categoria:"E-2", data:"11 mar 2026", leitura:"10 min", imagem:"https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&q=80&fit=crop", excerpt:"O E-2 permite que investidores de paises com tratado abram e operem negocios nos EUA. Saiba como estruturar seu plano e qualificar seu investimento."},
  ...
  {id:15, titulo:"Visto F-1: Como Estudar nos EUA e Construir um Caminho Imigratório", categoria:"F-1", data:"15 mar 2026", leitura:"9 min", imagem:"https://images.unsplash.com/photo-1532094349884-543559371b9b?w=600&q=80&fit=crop", excerpt:"O F-1 e a porta de entrada de estudantes brasileiros nos EUA. Veja como aproveitar OPT, STEM extension e transitar para vistos de trabalho."},
  ...
  {id:20, titulo:"Visto R-1: O Caminho para Líderes e Trabalhadores Religiosos nos EUA", categoria:"R-1", data:"20 mar 2026", leitura:"8 min", imagem:"https://images.unsplash.com/photo-1589216532372-1c2a367900d9?w=600&q=80&fit=crop", excerpt:"Pastores, missionarios e profissionais religiosos podem atuar legalmente nos EUA com o R-1. Conheca os requisitos e como evoluir para o Green Card EB-4."},
